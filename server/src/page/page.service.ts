...
export class PageService {
  ...
  async create(options: any) {
    ...
    const page = await this.repo.create({
      ...
      markdownContent: options.markdown_content ?? null,
      customJs: options.custom_js ?? null,
      customCss: options.custom_css ?? null,
      description: options.description ?? null,
      isPublished: options.is_published ?? false,
  ...
  toApiResponse(page: any) {
    ...
    return {
      ...
      markdown_content: page.markdownContent ?? null,
      custom_js: page.customJs ?? null,
      custom_css: page.customCss ?? null,
