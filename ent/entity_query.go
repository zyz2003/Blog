...
func (_q *EntityQuery) QueryFileVersions() *FileEntityQuery {
...
func (_q *EntityQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *EntityQuery) FirstIDX(ctx context.Context) uint {
...
func (_q *EntityQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (_q *EntityQuery) OnlyIDX(ctx context.Context) uint {
...
func (_q *EntityQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (_q *EntityQuery) IDsX(ctx context.Context) []uint {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *EntityQuery) WithFileVersions(opts ...func(*FileEntityQuery)) *EntityQuery {
	query := (&FileEntityClient{config: _q.config}).Query()
...
func (_q *EntityQuery) loadFileVersions(ctx context.Context, query *FileEntityQuery, nodes []*Entity, init func(*Entity), assign func(*Entity, *FileEntity)) error {
